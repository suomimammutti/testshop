		...
		<TouchableNativeFeedback onPress={onPressed} >
			<View style={styles.container} >
				...
				<View style={styles.topContainer} onLayout={onCardLayout}>
					<AnimatedFasterImage source={{ url: currentImage, cachePolicy: 'memory', borderRadius: MainTheme.cardBorderRadius }} style={animatedImageStyle} />
				...
				{selected && descriptionHeight === 0 && (
					<View>
						<View onLayout={onDescriptionLayout} style={styles.absoluteFiller}>
							<Text style={[styles.descriptionCalculation]}>
								{product.description}
							</Text>
						</View>
					</View>
